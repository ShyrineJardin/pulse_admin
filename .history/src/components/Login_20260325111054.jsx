                ...
                <form action="">
                    <div className="flex flex-col gap-4 mt-6">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-2 bg-#F6F6F6 p-3 border border-[#D9D9D9] rounded-md focus-within:ring-2 focus-within:ring-primary">
                                <MdEmail className="" />
                                <input type="email" placeholder="juandelacruz@gmail.com" className=" placeholder:text-[#C5C5C5] border border-[#D9D9D9] rounded-md focus:outline-none focus:ring-2 focus:ring-primary" />
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
