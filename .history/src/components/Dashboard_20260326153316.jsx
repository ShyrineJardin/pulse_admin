    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 px-6 py-4 border-t border-gray-200">
          <button
            onClick={handleReset}
            className="flex-1 py-3 rounded-xl border border-dark-primary text-primary text-sm font-medium hover:bg-green-50 transition-colors"
          >
            Reset
          </button>
          <button
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-between mb-6 bg-[#F9FAFC] w-full p-6 border-b border-gray-200">
        <h1 className="text-xl font-bold">PulseTech Performance Report</h1>
