  ...
  return (
    <div className={`rounded-2xl border-2 border border-border overflow-hidden mb-3`}>
      ...
      <button
        ...
        className={`w-full py-3 text-sm font-medium text-gray-800 hover:text-dark text-center border-t border-gray-200 ${rowBg} hover:bg-gray-100 transition-colors`}
      >
