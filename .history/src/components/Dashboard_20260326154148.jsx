...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Header */}
      <div className="flex items-center flex-col md:flex-row justify-between mb-6 bg-[#F9FAFC] w-full p-4 border-b border-gray-200">
      ...
      <div className="flex items-center justify-center gap-2 mt-5 mb-5">
        <button
          ...
          className="flex items-center gap-1 px-3 py-2 text-sm border border-gray-200 rounded-lg text-gray-500 hover:bg-primary hover:text- disabled:opacity-40 disabled:cursor-not-allowed"
        >
          ← Previous
        </button>
