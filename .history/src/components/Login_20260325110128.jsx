            ...
            <div className="flex flex-col text-center gap-1">
                ...
                <form action="">
                    <div className="flex flex-col gap-4 mt-6">
                        ...
                        <input type="email" id="email" placeholder="juandelacruz@gmail.com" className="bg-#F6F6F6 p-3 placeholder:text-[#C5C5C5] border border-[#D9D9D9] rounded-md focus:outline-none focus:ring-2 focus:ring-primary" />
                        <div className="flex items-center justify-between">
                            <label htmlFor="password" className="text-subtext">Password</label>
                        </div>
                        <input type="password" id="password" placeholder="••••••••" className="bg-#F6F6F6 p-3 placeholder:text-[#C5C5C5] border border-[#D9D9D9] rounded-md focus:outline-none focus:ring-2 focus:ring-primary" />
                    </div>
                </form>
            </div>
