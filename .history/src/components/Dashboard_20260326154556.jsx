    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-center gap-2 mt-5 mb-5">
        <button
          ...
          className="flex items-center gap-1 px-3 py-2 textmd:text-sm border border-gray-200 rounded-lg text-gray-500 hover:bg-primary hover:text-btn-text disabled:opacity-40 disabled:cursor-not-allowed"
        >
          ← Previous
        </button>
