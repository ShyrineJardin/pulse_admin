...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <div className="flex items-center justify-between mb-6 bg-[#F9FAFC] w-full p-6 border-b-1 border-border">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex h-full items-center gap-2 px-3 py-2 text-sm bg-white border border-gray-200 rounded-lg text-gray-600 hover:scale-105">
            <FaFilter className="text-gray-400" />
          </button>
          <button className="flex items-center gap-2 px-4 py-2 text-sm bg-gray-900 text-p rounded-lg hover:bg-gray-800">
